                ...
                <div class="pd-20 card-box mb-30">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT * FROM anonymous_reports WHERE acc_status = '1'";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    echo "<a href='./php/anony_appr.php?id=" . $row["AID"] . "&action=reject&acc_status=" . $row["acc_status"] . "' class='badge badge-primary'>Close</a>";
