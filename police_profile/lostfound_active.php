                        ...
                        <?php
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    echo "<a href='./php/lostfound_appr.php?id=" . $row["lid"] . "&action=reject&lost_status=" . $row["lost_status"] . "' class='badge badge-primary'>Close</a>";
                                ...
                                echo "<tr><td colspan='6'>No active cases.</td></tr>";
                            }
                            $conn->close();
                            ?>
                        </tbody>
